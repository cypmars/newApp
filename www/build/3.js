...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__signup__ = __webpack_require__(599);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages__ = __webpack_require__(204);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SignupPage = (function () {
    ...
    SignupPage.prototype.next = function () {
        ...
        if (this.signupSlider._activeIndex == 4)
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__pages__["f" /* WelcomePage */]);
    ...
    SignupPage.prototype.save = function () {
        ...
        if (!this.slideOneForm.valid) {
            ...
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__pages__["a" /* MainPage */]);
        }
    };
    return SignupPage;
}());
