                                ...
                                if (parts) {
                                    for (var _i = 0, contexts_1 = contexts; _i < contexts_1.length; _i++) {
                                        ...
                                        if (context.name == "aider-yes-type-agro-custom-followup") {
                                            _this.myArray = new Array();
                                            var compute = new __WEBPACK_IMPORTED_MODULE_5__providers_ComputeResultsService__["a" /* ComputeResultsService */]();
                                            _this.myArray = compute.computeResults(context.parameters.type, "Agro-alimentaire", context.parameters.agroJobs);
                                        }
                                    }
                                    var newM = {
                                        toId: _this.user._id,
