...
var ServiceDetailsPage = (function () {
    function ServiceDetailsPage(navCtrl, navParams, toastCtrl, http, youtube) {
        ...
        servData.subscribe(function (data) {
            ...
            console.log(_this.buttonInfo);
            if (_this.buttonInfo != null) {
                _this.buttonInfo.removeAttribute("hidden");
                _this.buttonInfo.srcElement.style.zIndex = 1000;
            }
        });
    }
