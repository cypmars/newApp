...
var ServiceDetailsPage = (function () {
    ...
    ServiceDetailsPage.prototype.showProduct = function (event, index) {
        console.log(index);
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__pages__["b" /* ProductDetailsPage */], {
            productId: index
        });
    };
